...
namespace GtaCheatsSearchApp
{
    public partial class GtaSanAndreas : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SearchSanAndreasCheats();

        }
        public void SearchSanAndreasCheats()
        {
            ...
            string selectCheat = $"Select Cheat,Action from GTASACHEATS Where Action='{textBox1.Text}'";

            string selectAllCheats = $"Select Cheat,Action from GTASACHEATS";
